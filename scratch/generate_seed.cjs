...
const VISION_GALLERIES = {
  ...
  "promoting-entrepreneurship-employment": {
    ...
    images: [
      ...
      { id: "img-60", url: "/Promoting%20Entrepreneurship%20&%20Employment/1127828532720176_3092620948142861044_n.jpg" },
...
initialPosts.forEach(post => {
    ...
    INSERT INTO public.posts (
        ...
        'news', '${title}', '${excerpt}', '${content}', '${category}', '${theme}', ${tags}, '${slug}', '${createdAt}', 'published', admin_id
