...
const colorMap: Record<string, { bg: string; text: string }> = {
  humanitarian: { bg: 'bg-[#F42A41]/10', text: 'text-[#F42A41]/90' },
  education: { bg: 'bg-[#D4AF37]/10', text: 'text-[#D4AF37]/90' },
  security: { bg: 'bg-army-navy/10', text: 'text-army-navy/90' },
  veterans: { bg: 'bg-[#006A4E]/10', text: 'text-[#006A4E]/90' },
  civic: { bg: 'bg-army-olive/10', text: 'text-army-olive/90' },
};
...
export const ImpactAreas: React.FC = () => {
  ...
  const getCounts = (area: string) => articlePosts.filter((post) => post.theme === area).length;

  return (
    <section className="py-10 sm:py-16 bg-white">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        <div className="text-center mb-8 sm:mb-12">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-serif font-bold text-[#006A4E]/90 mb-2">
            Areas of Impact
          </h2>
